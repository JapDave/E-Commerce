...
class Products(models.Model):
        ...
        product_enterprsie = ChainedForeignKey(Enterprise_Detail,verbose_name=("Product-Enterprise"),chained_field='product_categories',chained_model_field="enterprise_categories",default="")
